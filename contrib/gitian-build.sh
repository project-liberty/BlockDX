...
VERSION=
commit=false
url=https://github.com/project-liberty/BlockDX
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/project-liberty/BlockDX
...
then
    ...
    git clone https://github.com/project-liberty-project/gitian.sigs.git
    #TODO Repo? git clone https://github.com/project-liberty/BlockDX-detached-sigs.git

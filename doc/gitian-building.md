...
git clone https://github.com/project-liberty-crypto/liberty.git
cd liberty
...
```bash
    ...
    From https://github.com/project-liberty-crypto/liberty
...
[liberty/gitian.sigs](https://github.com/project-liberty-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.

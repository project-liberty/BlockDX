...
pkgdatadir = $(datadir)/liberty
pkgincludedir = $(includedir)/liberty
pkglibdir = $(libdir)/liberty
pkglibexecdir = $(libexecdir)/liberty
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/ax_boost_date_time.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/config/liberty-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/liberty-config.h.in \
...
ACLOCAL = ${SHELL} /Users/martinmizzell/repos/libertycoin/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/martinmizzell/repos/libertycoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/martinmizzell/repos/libertycoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/martinmizzell/repos/libertycoin/build-aux/missing automake-1.16
AWK = awk
BDB_CPPFLAGS =  -I/opt/local/include/db48/
BDB_LIBS = -ldb_cxx-4.8
BOOST_CHRONO_LIB = -lboost_chrono-mt
BOOST_CPPFLAGS = -pthread -I/usr/local/Cellar/boost@1.55/1.55.0_1/include
BOOST_DATE_TIME_LIB = -lboost_date_time-mt
BOOST_FILESYSTEM_LIB = -lboost_filesystem
BOOST_LDFLAGS = -L/usr/local/Cellar/boost@1.55/1.55.0_1/lib
BOOST_LIBS = -L/usr/local/Cellar/boost@1.55/1.55.0_1/lib -lboost_system -lboost_filesystem -lboost_program_options-mt -lboost_thread-mt -lboost_date_time-mt -lboost_chrono-mt
...
CXXFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wno-inconsistent-missing-override  -Wstack-protector -fstack-protector-all -fPIC -fvisibility=hidden
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
MAINT = 
MAKEINFO = ${SHELL} /Users/martinmizzell/repos/libertycoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OBJCXXFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wno-inconsistent-missing-override  -Wstack-protector -fstack-protector-all -fPIC
OBJDUMP = objdump
OBJEXT = o
OTOOL = otool
OTOOL64 = :
PACKAGE = liberty
PACKAGE_BUGREPORT = www.lbrt.io
PACKAGE_NAME = Liberty Core
PACKAGE_STRING = Liberty Core 4.0.4
PACKAGE_TARNAME = liberty
PACKAGE_URL = 
...
abs_builddir = /Users/martinmizzell/repos/libertycoin
abs_srcdir = /Users/martinmizzell/repos/libertycoin
abs_top_builddir = /Users/martinmizzell/repos/libertycoin
abs_top_srcdir = /Users/martinmizzell/repos/libertycoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/martinmizzell/repos/libertycoin/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/libertyd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/liberty-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/liberty-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = Liberty-Wallet.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_liberty_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_liberty_coverage.info test_liberty.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/liberty-qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/liberty-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/liberty-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/liberty-config.h
$(top_srcdir)/src/config/liberty-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/liberty-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/liberty-qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/liberty-qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/liberty-qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_liberty.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_liberty -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_liberty_filtered.info: test_liberty.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_liberty_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_liberty_coverage.info: baseline_filtered_combined.info test_liberty_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_liberty_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_liberty_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_liberty_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_liberty.coverage/.dirstamp:  test_liberty_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_liberty.coverage/.dirstamp total.coverage/.dirstamp

# Liberty: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_liberty.coverage/ total.coverage/ $(OSX_APP)

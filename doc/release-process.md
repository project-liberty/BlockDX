...
* Update translations (ping hanniabu on Rocket.Chat) see [translation_process.md](https://github.com/project-liberty/BlockDX/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    #TODO git clone https://github.com/project-liberty-project/gitian.sigs.git
    #TODO git clone https://github.com/project-liberty/BlockDX-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/project-liberty/BlockDX.git
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/project-liberty/BlockDX/releases/new) with a link to the archived release notes.
